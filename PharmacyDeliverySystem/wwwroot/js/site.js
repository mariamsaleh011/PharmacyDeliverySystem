...
//            <img src="${i.imageUrl || 'fallback.png'}" alt="${i.name}" />
//        </div>
...
function addToCart(name, price, productId, imageUrl) {
    ...
    if (idx >= 0) {
        ...
        // تخزين imageUrl مع باقي البيانات
...
function renderCart() {
    ...
    // 🚀 التعديل النهائي هنا لعرض الصورة والتحكم في الكمية
    cartList.innerHTML = items.map(i => `
        <div class="cart-item">
            <div class="cart-item-image">
                <img src="${i.imageUrl || 'fallback.png'}" alt="${i.name}" />
